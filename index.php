  ...
  <body>
    ...
    <div class="menu" id="menu">
      <ul class="list" id="list">
        <?php
          $types = Array(
              Array('startup', 'Automobile'),
              Array('accelerator','Capacitors'),
              Array('incubator', 'Chemicals'),
              Array('coworking', 'CNC'),
    ...
    <div class="modal hide" id="modal_info">
      ...
      <div class="modal-body">
        <p>
          We built this map to connect and promote the industries community
          in our beloved Hosur. We've seeded the map but we need
          ...
          <?php } ?>
          Let's put Hosur on the map together!
        </p>
        <p>
        Questions? Feedback? Connect with us: <a href="http://www.twitter.com/<?= $twitter['username'] ?>" target="_blank">@<?= $twitter['username'] ?></a>
        </p>
        <p>
          If you want to support the Hosur Map by linking to this map from your website,
          here are some badges you might like to use. You can also grab the <a href="./images/badges/badge1.png">Hosur Map Icon</a>.
        </p>
        <ul class="badges">
          <li>
          ...
          <li>
            <img src="./images/badges/m.gif" alt="">
          </li>
          <li>
            <img src="./images/badges/badge1.png" alt="">
          </li>
        ...
        <p>
          This map was built with <a href="https://www.FixRnix.in">FixNix</a> - an open source security solution company
          Check out security <a target="_blank" href="http://www.fixRnix.in">solutions</a> built for Small, Medium Business!
        </p>
      </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="type" id="add_type" class="input-xlarge">
                  <option value="startup">Automobile</option>
                  <option value="accelerator">Capacitors</option>
                  <option value="incubator">Chemicals</option>
                  <option value="coworking">CNC</option>
                  <option value="investor">Conveyors</option>
                  <option value="service">Electrical</option>
                  <option value="hackerspace">Electronics</option>
                </select>
              </div>
            </div>
            <div class="control-group">
      ...
      $("#modal_addform").submit(function(event) {
        ...
        $.post( url, { owner_name: owner_name, owner_email: owner_email, title: title, type: type, address: address, uri: uri, description: description },
          function( data ) {
            ...
            if(data == "success") {
              $("#modal_addform #result").html("HOSTIA has received your submission and will review it shortly. Thanks!");
